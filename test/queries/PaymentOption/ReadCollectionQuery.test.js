...
import ReadCollectionQuery from '../../../src/queries/PaymentOption/ReadCollectionQuery.js';
...
test('ReadCollectionQuery should read all payment options', async () => {
...
test('ReadCollectionQuery should be able to paginate payment options if page and limit is provided', async () => {
