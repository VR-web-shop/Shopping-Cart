...
import ReadCollectionQuery from '../../../src/queries/Product/ReadCollectionQuery.js';
...
test('ReadCollectionQuery should read all products', async () => {
...
test('ReadCollectionQuery should be able to paginate products if page and limit is provided', async () => {
