...
router.route('/api/v1/admin/product_order_states')
    /**
     * @openapi
     * '/api/v1/admin/product_order_states':
     *  get:
     *     tags:
     *       - Admin Product Order State Controller
     *     summary: Get all product order states
     *     security:
     *      - bearerAuth: []
     *     responses:
     *      200:
    ...
    .get(async (req, res) => {
        try {
            ...
            res.send({ 
                ...
                count, 
                pages,
                ...LinkService.paginateLinks(`api/v1/admin/product_order_states`, parseInt(page), pages), 
            })
        } catch (error) {
